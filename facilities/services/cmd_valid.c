...
static SOPCLASSPERMITTEDSRV classPermittedSrvTable[] = {
    ...
    { DICOM_SOPCLASSSECONDARYCAPTUREBLACKWHITE, storageSOPClass, 2 },
    { DICOM_SOPCLASSSECONDARYCAPTUREGRAYSCALE, storageSOPClass, 2 },
    { DICOM_SOPCLASSSECONDARYCAPTUREGRAYSCALEWORD, storageSOPClass, 2 },
    { DICOM_SOPCLASSSECONDARYCAPTURECOLOR, storageSOPClass, 2 },
    ...
    { DICOM_SOPCLASSBREASTTOMOSYNTHESIS_STORAGE, storageSOPClass, 2 },
