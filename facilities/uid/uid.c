...
** Last Update:		$Author: smm $, $Date: 2006-08-16 04:01:20 $
** Source File:		$RCSfile: uid.c,v $
** Revision:		$Revision: 1.33 $
** Status:		$State: Exp $
*/

static char rcsid[] = "$Revision: 1.33 $ $RCSfile: uid.c,v $";
...
static UID_DESCRIPTION table[] = {
    ...
    {UID_CLASS_K_TRANSFERSYNTAX, DICOM_TRANSFERBIGENDIANEXPLICIT,
    "Explicit Big-Endian Transfer Syntax", "NEMA"},
    {UID_CLASS_K_TRANSFERSYNTAX, DICOM_TRANSFERJPEGBASELINEPROCESS1,
    "Explicit VR, Lossy JPEG 8-Bit Image Compression", "NEMA"},
    {UID_CLASS_K_TRANSFERSYNTAX, DICOM_TRANSFERJPEGEXTENDEDPROC2AND4,
    "Explicit VR, Lossy JPEG 12-Bit Image Compression", "NEMA"},
    {UID_CLASS_K_TRANSFERSYNTAX, DICOM_TRANSFERRLE,
    "Explicit VR,RLE", "NEMA"},
...
/*UID_CLASS_K_SOPCLASS, DICOM_SOPCLASSPREFORMATTEDCOLORIMAGE */
	 {UID_CLASS_K_METASOPCLASS, DICOM_SOPCLASSSTOREDPRINT,
	 "Stored Print Storage", "NEMA"},
	 {UID_CLASS_K_METASOPCLASS, DICOM_SOPCLASSHARDCOPYGRAYSCALEIMAGE,
	 "Hardcopy Gray Image Storage", "NEMA"},
	 {UID_CLASS_K_METASOPCLASS, DICOM_SOPCLASSHARDCOPYCOLORIMAGE,
	 "Hardcopy Color Image Storage", "NEMA"},
    ...
    {UID_CLASS_K_SOPCLASS, DICOM_SOPCLASSSECONDARYCAPTUREBLACKWHITE,
    "Secondary Capture Black and White Image Storage", "NEMA"},
    {UID_CLASS_K_SOPCLASS, DICOM_SOPCLASSSECONDARYCAPTUREGRAYSCALE,
    "Secondary Capture 8-bit Grayscale Image Storage", "NEMA"},
    {UID_CLASS_K_SOPCLASS, DICOM_SOPCLASSSECONDARYCAPTUREGRAYSCALEWORD,
    "Secondary Capture 16-bit Grayscale Image Storage", "NEMA"},
    {UID_CLASS_K_SOPCLASS, DICOM_SOPCLASSSECONDARYCAPTURECOLOR,
    "Secondary Capture Color Image Storage", "NEMA"},
